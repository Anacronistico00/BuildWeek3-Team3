      ...
      <Navbar className="px-0 py-1" fixed="top" bg="light" expand="lg">
        <Container className="position-relative">
          <Row className="w-100">
                    ...
                    <Dropdown.Item>
                      <div style={{ display: "flex", alignItems: "center" }}>
                        ...
                        <div>
                          ...
                          <p>
                            {profile.profileInfo && profile.profileInfo.bio}
                          </p>
                        </div>
                      </div>
                    </Dropdown.Item>
            ...
            <Col xs={2} xl={3} className="border-start ms-0 ">
              <Dropdown className="navbar-dropdown" drop={"center"}>
                <DropdownToggle
                  variant="transparent "
                  id="dropdown-basic"
                  className=" d-flex flex-column justify-content-center align-content-center p-0"
                >
                  <div className=" text-center">
                    <Grid3x3 className="HomeIcons mb-0 mt-2" />
                    <p className="SubsIcon d-none d-md-block">Per le aziende</p>
                    <CaretDownFill className="toggleIcon" />
                  </div>
                </DropdownToggle>
                  ...
                  <Container fluid>
                    <Row>
                      <Col xs={12} lg={6} className=" pt-lg-0 mt-4 ">
                        ...
                        <h5 className=" text-secondary smallertext">
                          Marketing
                        </h5>
                        <div className=" mx-3 my-4 ">
                          <svg
