    ...
    return (
        <>
            <Container fluid className=' p-3 bg-white card first-card mb-2'>
                <Row>
                    <Col xs={12} className=' position-relative'>
                        <h2 className=' mb-1'>Lingua del profilo <span><HiOutlinePencil size={22} className='pencil' /></span></h2>
                        <p>Italiano</p>
                    </Col>
                </Row>
                <hr className='mt-0' />
                <Row>
                    <Col xs={12} className=' position-relative'>
                        <h2 className='mb-1'>Profilo pubblico e URL <span><HiOutlinePencil size={22} className='pencil' /></span></h2>
            ...
            <Container fluid className='card third-card mb-2 bg-white p-0'>
                            ...
                            <ListGroup>
                                <ListGroup.Item className='px-0'>
                                    <Container fluid className='p-0'>
                                        <Row className='p-0'>
                                            <Col xs={3}>
                                                <img src="/src/assets/img/imgProfilo.png" alt="immagine profilo" width="100%" />
                                            </Col>
                                            <Col xs={9} className='ps-0 pt-1'>
                                                <h3 className='m-0'>Nome Cognome <span>&bull; 3°</span></h3>
                ...
                <hr className='m-0' />
                <Container fluid className='p-0 d-flex justify-content-center align-content-center button-mostra'>
